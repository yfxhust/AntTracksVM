...
char* AllocationTracingSelfMonitoring::get_event_name(EventType type) {
    switch(type) {
        ...
        case EVENTS_GC_OBJ_PTR: return (char*) "events_GC_obj_ptr";
        case EVENTS_GC_CROSSGENERATIONAL_PTR: return (char*) "events_GC_crossgenerational_ptr";
        case EVENTS_GC_OBJ_ARR_PTR: return (char*) "events_GC_obj_arr_ptr";
