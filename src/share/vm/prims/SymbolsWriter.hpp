...
#define MAGIC_BYTE_MIRROR_INFO 55
#define MAGIC_BYTE_TYPE_INFO 56
#define MAGIC_BYTE_TYPE_SUPER_INFO 57
...
public:
    ...
    void write_symbols(SymbolsType symbol, oop o = NULL, Klass* k = NULL);
protected:
