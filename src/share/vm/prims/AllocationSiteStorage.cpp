...
#ifdef ASSERT
        bool filler = (allocation_site == ALLOCATION_SITE_IDENTIFIER_VM_INTERNAL || allocation_site == ALLOCATION_SITE_IDENTIFIER_VM_GC) && (obj->klass() == Universe::typeArrayKlassObj(T_INT) || obj->klass() == SystemDictionary::Object_klass());
