...
#define ALLOCATED_TYPE_IDENTIFIER_FIRST_CUSTOM 1
...
public:
    ...
    static void write_mirror_symbols(oop o, Klass* k);
...
private:
    ...
    static void write_symbols(AllocatedTypeIdentifier allocated_type_id, Klass* allocated_type, oop o = NULL, Klass* k = NULL);
