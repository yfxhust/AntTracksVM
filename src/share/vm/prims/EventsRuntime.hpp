...
DEFINE_EVENT(0x2B, EVENTS_GC_OBJ_PTR)                              // [ EVENT_TYPE (6) | _ (2) | PTR_KINDS_ENCODING (24) | ROOT (64) | PTRS (VAR up to 12 * 64) ]
DEFINE_EVENT(0x2C, EVENTS_GC_OBJ_ARR_PTR)                          // [ EVENT_TYPE (6) | _ (2) | PTR_KINDS_ENCODING (24) | ROOT (64) | PTRS (VAR up to 12 * 64) ]
DEFINE_EVENT(0x2D, EVENTS_GC_ROOT_PTR)                             // [ EVENT_TYPE (6) | _ (2) | PTR_KINDS_ENCODING (24) | ROOT (64) | PTRS (VAR up to 12 * 64) ]
DEFINE_EVENT(0x2E, EVENTS_GC_CROSSGENERATIONAL_PTR)                // [ EVENT_TYPE (6) | _ (2) | PTR_KINDS_ENCODING (24) | ROOT (64) | PTRS (VAR up to 12 * 64) ]
        
#define EVENT_COUNT (0x2E + 1)
...
public:
    ...
    static void fire_gc_start_end(EventType event_type, jint id, GCType gc_type, GCCause::Cause gc_cause, bool failed = false, bool force_flush = false);
    ...
    static void fire_gc_root_ptr(EventType event_type, uintptr_t obj, bool obj_is_inside_heap);
    ...
    static void fire_region_alloc();
    static void fire_region_release();
...
private:
    ...
    static inline void write_gc_event(jint* local_buffer_top, EventType event_type, GCType gc_type, GCCause::Cause gc_cause, bool failed);
