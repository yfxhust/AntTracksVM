...
void HeapRegionDCTOC::walk_mem_region(MemRegion mr,
  ...
  if (!g1h->is_obj_dead(oop(cur), _hr)) {
    if(TraceObjectsPointers) { Thread::current()->get_event_obj_ptrs()->set_meta(EVENTS_GC_CROSSGENERATIONAL_PTR, (uintptr_t) (HeapWord*) cur, true); }
...
oops_on_card_seq_iterate_careful(MemRegion mr,
  ...
  do {
    ...
    if (!g1h->is_obj_dead(obj)) {
      ...
      if(TraceObjectsPointers) { Thread::current()->get_event_obj_ptrs()->set_meta(EVENTS_GC_CROSSGENERATIONAL_PTR, (uintptr_t) (HeapWord*) tmp, true); }
