...
//       ((CardTableModRefBS*) Universe::heap()->barrier_set())->printCardTable(false);
//       
...

    {
      ...
      if(TraceObjectsPointers){ Thread::current()->get_event_root_ptrs()->set_meta(EVENTS_GC_ROOT_PTR, 11, false); }
